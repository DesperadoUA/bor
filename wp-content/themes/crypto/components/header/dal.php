<?php 
$data = [];
$logo = get_img_item(carbon_get_theme_option( OPTIONS_KEYS['LOGO']));
$fb = carbon_get_theme_option( OPTIONS_KEYS['FB']);
$tw = carbon_get_theme_option( OPTIONS_KEYS['TW']);
$children_menu = [];
...
$menuData = new MenuData($menuList);
$social = new SocialLinks($fb, $tw);
global $builder;
echo $builder->header($logo, $menuData, $social);
?>