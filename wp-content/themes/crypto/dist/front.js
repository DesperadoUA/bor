			...
			transition: {
				...
				transitionStart: function (e, t) {
					...
					const s = this,
						{ params: a } = s
					a.cssMode ||
						(a.autoHeight && s.updateAutoHeight(), B({ swiper: s, runCallbacks: e, direction: t, step: 'Start' }))
				},
				transitionEnd: function (e, t) {
					...
					const s = this,
						{ params: a } = s
					;(s.animating = !1),
						a.cssMode || (s.setTransition(0), B({ swiper: s, runCallbacks: e, direction: t, step: 'End' }))
				}
			},
			slide: Y,
			loop: R,
